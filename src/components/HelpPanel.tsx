      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl z-50 overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-slate-900">Help & Instructions</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-6 space-y-6">
          <section>
            <h3 className="text-lg font-semibold text-slate-900 mb-3">Dashboard Overview</h3>
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-900 mb-3">Connecting Your Robotic Arm</h3>
            <div className="space-y-3">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-medium text-slate-900 mb-2">Step 1: Register Your Arm</h4>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-medium text-slate-900 mb-2">Step 2: Get Your Arm ID</h4>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-medium text-slate-900 mb-2">Step 3: Configure Your Arm</h4>
                <p className="text-sm text-slate-700 mb-2">
                  Program your robotic arm controller to send data to:
                </p>
                <div className="bg-white rounded p-2 text-xs font-mono break-all mb-2">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-medium text-slate-900 mb-2">Step 4: Send Data</h4>
                <p className="text-sm text-slate-700 mb-2">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h4 className="font-medium text-slate-900 mb-2">✓ Real-Time Updates</h4>
                <p className="text-sm text-slate-700">
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-900 mb-3">Using the Dashboard</h3>
            <div className="space-y-3">
              <div className="bg-slate-50 rounded-lg p-4">
                <h4 className="font-medium text-slate-900 mb-2">1. Select a Robotic Arm</h4>
                <p className="text-sm text-slate-700">
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                <h4 className="font-medium text-slate-900 mb-2">2. Monitor Metrics</h4>
                <p className="text-sm text-slate-700">
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                <h4 className="font-medium text-slate-900 mb-2">3. Manage Alerts</h4>
                <p className="text-sm text-slate-700">
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-900 mb-3">Status Indicators</h3>
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600">System is operational and running normally</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600">System has encountered an error requiring attention</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600">System is undergoing scheduled maintenance</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600">System is not currently connected</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-900 mb-3">Alert Severity Levels</h3>
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <div className="px-2 py-1 bg-red-100 rounded text-xs font-semibold text-red-700">
                  CRITICAL
                </div>
                <p className="text-sm text-slate-700">Immediate action required</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="px-2 py-1 bg-amber-100 rounded text-xs font-semibold text-amber-700">
                  WARNING
                </div>
                <p className="text-sm text-slate-700">Attention needed soon</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="px-2 py-1 bg-blue-100 rounded text-xs font-semibold text-blue-700">
                  INFO
                </div>
                <p className="text-sm text-slate-700">Informational message</p>
              </div>
            </div>
          </section>

          <section>
            <h3 className="text-lg font-semibold text-slate-900 mb-3">Managing Robotic Arms</h3>
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-900 mb-3">Understanding Metrics</h3>
